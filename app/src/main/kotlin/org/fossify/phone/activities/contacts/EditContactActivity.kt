package org.fossify.phone.activities.contacts
...
import org.fossify.phone.adapters.AutoCompleteTextViewAdapter
import org.fossify.phone.databinding.*
import org.fossify.phone.dialogs.*
import org.fossify.phone.extensions.*
import org.fossify.phone.helpers.ADD_NEW_CONTACT_NUMBER
import org.fossify.phone.helpers.IS_FROM_SIMPLE_CONTACTS
import org.fossify.phone.helpers.KEY_EMAIL
import org.fossify.phone.helpers.KEY_NAME
        ...
        phoneNumbers.forEachIndexed { index, number ->
            ...
            numberHolder.apply {
                ...
                if (config.hidePhoneNumber) {
                    contactNumber.applyBlurEffect(config) // blur
                    contactNumber.isEnabled = false
                    btnShowNumber.isVisible = true
                } else {
                    contactNumber.removeBlurEffect()
                    contactNumber.isEnabled = true
                    btnShowNumber.isVisible = false
                }
