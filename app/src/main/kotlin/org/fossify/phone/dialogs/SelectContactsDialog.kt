...
import org.fossify.phone.adapters.SelectContactsAdapter
import org.fossify.phone.databinding.DialogSelectContactsBinding
...
class SelectContactsDialog(
    ...
    private val binding = DialogSelectContactsBinding.inflate(activity.layoutInflater)
